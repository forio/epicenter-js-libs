...
The Epicenter.js library is available from our tools: <a href="https://forio.com/tools/js-libs/1.8/epicenter.min.js" target="_blank">https://forio.com/tools/js-libs/1.8/epicenter.min.js</a>. To use it in your project, simply add

    <script src="https://forio.com/tools/js-libs/1.8/epicenter.min.js"></script>
