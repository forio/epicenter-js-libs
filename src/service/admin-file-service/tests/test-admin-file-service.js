...
var baseURL = (new URLService({ accountPath: account, projectPath: project })).getAPIPath('file');
var uploadBase = (new URLService({ accountPath: account, projectPath: projectUpload })).getAPIPath('file');
