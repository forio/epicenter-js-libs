...
"use strict";module.exports={_pick:function(obj,props){var res={};for(var p in obj)-1!==props.indexOf(p)&&(res[p]=obj[p]);return res},isEmpty:function(value){return!value||$.isPlainObject(value)&&0===Object.keys(value).length}};
