...
"use strict";var classFrom=require("../../util/inherit");var injectFiltersFromSession=require("../strategy-utils").injectFiltersFromSession;var injectScopeFromSession=require("../strategy-utils").injectScopeFromSession;var Base={};module.exports=classFrom(Base,{constructor:function(options){var strategyOptions=options?options.strategyOptions:{};this.options=strategyOptions},reset:function(runService,userSession){var opt=injectScopeFromSession(runService.getCurrentConfig(),userSession);return runService.create(opt).then(function(createResponse){return runService.save({trashed:!1}).then(function(patchResponse){return $.extend(!0,{},createResponse,patchResponse,{freshlyCreated:!0})})})},getRun:function(runService,userSession){var filter=injectFiltersFromSession({saved:!1,trashed:!1},userSession);var me=this;var outputModifiers={sort:"created",direction:"desc"};return runService.query(filter,outputModifiers).then(function(runs){return runs.length?runs[0]:me.reset(runService,userSession)})}},{requiresAuth:!1});
