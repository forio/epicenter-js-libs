...
"use strict";var ConfigService=require("./configuration-service");var TransportFactory=require("../transport/http-transport-factory");module.exports=function(config){var defaults={server:{versionPath:"v3/"}};var serviceOptions=$.extend({},defaults,config);var urlConfig=new ConfigService(serviceOptions).get("server");serviceOptions.account&&(urlConfig.accountPath=serviceOptions.account),serviceOptions.project&&(urlConfig.projectPath=serviceOptions.project),urlConfig.filter=";";var httpOptions={url:urlConfig.getAPIPath("model")+"publish"};serviceOptions.token&&(httpOptions.headers={Authorization:"Bearer "+serviceOptions.token});var http=new TransportFactory(httpOptions);var publicAPI={get:function(runId,options){var httpOptions=$.extend(!0,{},serviceOptions,options);var params={runId:runId||httpOptions.filter,commandWrapper:{command:{introspect:{}}},reanimate:!1};return http.post(params,httpOptions)}};$.extend(this,publicAPI)};
