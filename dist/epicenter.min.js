...
"use strict";var Channel=function(n){var t={base:"",topicResolver:function(n){return n},transport:null};this.channelOptions=$.extend(!0,{},t,n)},makeName=function(n,t){var e=(n?n+"/"+t:t).replace(/\/\//g,"/").replace(/\/$/,"");return e};Channel.prototype.subscribe=function(n,t){var e=[].concat(n),a=this,r=[],o=a.channelOptions;return o.transport.batch(function(){$.each(e,function(n,e){e=makeName(o.base,o.topicResolver(e)),r.push(o.transport.subscribe(e,t))})}),r[1]?r:r[0]},Channel.prototype.publish=function(n,t){var e=[].concat(n),a=this,r=[],o=a.channelOptions;return o.transport.batch(function(){$.each(e,function(n,e){e=makeName(o.base,o.topicResolver(e)),"*"===e.charAt(e.length-1)&&(e=e.replace(/\*+$/,""),console.warn("You can cannot publish to channels with wildcards. Publishing to ",e,"instead")),r.push(o.transport.publish(e,t))})}),r[1]?r:r[0]},Channel.prototype.unsubscribe=function(n){return this.channelOptions.transport.unsubscribe(n),n},module.exports=Channel;
